...
typedef struct _lv_indev_drv_t
{
    ...
    bool (*read_cb)(struct _lv_indev_drv_t * indev_drv,
                    lv_indev_data_t * data); /*Function pointer to read_cb data. Return 'true' if
                                                there is still data to be read_cb (buffered)*/

#if LV_USE_USER_DATA_MULTI
    lv_indev_drv_user_data_t
        read_user_data; /*Pointer to user defined data, passed in 'lv_indev_data_t' on read*/
#endif
