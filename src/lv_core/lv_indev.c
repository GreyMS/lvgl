        ...
        if(i->proc.disabled == 0) {
            ...
            do {
                ...
                indev_proc_reset_query_handler(
                    i); /*The active object might deleted even in the read function*/
...
static void indev_keypad_proc(lv_indev_t * i, lv_indev_data_t * data)
{
    ...
    /*Pressing*/
        ...
        /*Long press repeated time has elapsed?*/
                ...
                lv_tick_elaps(i->proc.longpr_rep_timestamp) > LV_INDEV_LONG_PRESS_REP_TIME) {
...
static void indev_drag_throw(lv_indev_proc_t * proc)
{
    ...
    /*Reduce the vectors*/
    proc->types.pointer.drag_throw_vect.x =
        proc->types.pointer.drag_throw_vect.x * (100 - LV_INDEV_DRAG_THROW) / 100;
    proc->types.pointer.drag_throw_vect.y =
        proc->types.pointer.drag_throw_vect.y * (100 - LV_INDEV_DRAG_THROW) / 100;
